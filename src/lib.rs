...
pub fn engaucanberra(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str3 = &str2.replace("i'd", "ɑ̝ed");
    let str4 = &str3.replace("i’d", "ɑ̝ed");
    let str5 = &str4.replace("i'll", "ɑ̝el");
    let str6 = &str5.replace("i’ll", "ɑ̝el");
    let str7 = &str6.replace("i'm", "ɑ̝em");
    let str8 = &str7.replace("i’m", "ɑ̝em");
    let str9 = &str8.replace("i've", "ɑ̝ev");
    let str10 = &str9.replace("i’ve", "ɑ̝ev");
    let str11 = &str10.replace("'", "");
    let str12 = &str11.replace('’', "");
    let str13a = &str12.replace("etc.", "etˈsɛ̝t͡ʃɹə.");
    let str13b = &str13a.replace("eah", "ɶ̜ə");
    let str14 = &str13b.replace("answ", "ɐ̞ːns");
    let str15 = &str14.replace("ballet", "bɐlei^");
    ...
    let str26 = &str25.replace("ionaire", "io̝ːnə");
    ...
    let str86 = &str85.replace("sword", "sɞːd̥");
    let str87 = &str86.replace("ord", "ə̟ːd");
    let str88 = &str87.replace("orld", "ə̟ːld");
    let str89 = &str88.replace("ork", "ə̟ːk");
    let str89a = &str89.replace("urn", "ə̟ːn");
    let str90 = &str89a.replace("orth", "o̝ːθ");
    let str91 = &str90.replace("ore̞st", "o̝ɹest");
    let str92 = &str91.replace("ore", "o̝ː");
    let str93a = &str92.replace("ory", "ɔ̝ːɾy");
    let str93b = &str93a.replace("or", "ɔ̝ː");
    let str94 = &str93b.replace("air", "eː");
    let str95 = &str94.replace("there", "ðeː");
    let str96 = &str95.replace("were", "weː");
    let str97 = &str96.replace("circ", "sə̟ːc");
    let str98a = &str97.replace("ira", "ɑ̝era");
    let str98b = &str98a.replace("iro", "ɑ̝ero");
    let str99a = &str98b.replace("irr", "iɹ");
    let str99b = &str99a.replace("ir", "ə̟ː");
    let str99c = &str99b.replace("urr", "ɐɹ");
    let str99d = &str99c.replace("urse", "ə̟ːs");
    let str100a = &str99d.replace("isl", "ɑ̝el");
    let str100b = &str100a.replace("exp", "ixp");
    let str101 = &str100b.replace("rious", "ɹiəs");
    let str102 = &str101.replace("cious", "ʃiəs");
    let str103 = &str102.replace("tious", "ʃiəs");
    let str104 = &str103.replace("ous", "əs");
    ...
    let str111 = &str110.replace("ourse", "o̝ːs");
    ...
    let str119 = &str118.replace("ounci", "æɔ̞̃nsi");
    let str120 = &str119.replace("ound", "æɔ̞̃nd̥");
    let str122 = &str120.replace("ceipt", "ceit");
    let str125 = &str122.replace("ow", "æ̞ɔ̞");
    let str126 = &str125.replace("wea", "weˑ");
    let str127 = &str126.replace("eady", "edy");
    let str128 = &str127.replace("eason", "ᵊiːz̥ᵊn");
    let str129 = &str128.replace("ear ", "iə ");
    let str130 = &str129.replace("ear", "eː");
    let str131 = &str130.replace("eali", "ᵊiːəli");
    let str132a = &str131.replace("ea", "ᵊiː");
    let str132b = &str132a.replace("who ", "hʉ̟ː ");
    let str132c = &str132b.replace("who", "ho");
    let str132d = &str132c.replace("wh", "w");
    let str133 = &str132d.replace("aunt", "ɐ̞ːnt");
    let str134 = &str133.replace("daughter", "dɔ̝tə");
    let str135a = &str134.replace("au", "ɔ̝");
    let str135b = &str135a.replace("any", "æ̃ni");
    let str136 = &str135b.replace("archi", "ɐːkʰi");
    let str138 = &str136.replace("arm", "õ̝ːm");
    let str139 = &str138.replace("arn", "õ̝ːn");
    let str140a = &str139.replace("harr", "hɶ̜ɹ");
    let str140b = &str140a.replace("arr", "əɹ");
    let str141 = &str140b.replace("are ", "ɐ̞ː ");
    let str142 = &str141.replace("eyre", "eː");
    let str143 = &str142.replace("re ", "ə ");
    let str144 = &str143.replace(" ar", " əɹ");
    let str145 = &str144.replace("liar", "lɑ̝eə");
    let str146a = &str145.replace("ara", "ɐ̞ːɹa");
    let str146b = &str146a.replace("ar a", "ɐ̞ːɹ a");
    let str147 = &str146b.replace("ar e", "ɐ̞ːɹ e");
    let str148 = &str147.replace("ar o", "ɐ̞ːɹ o");
    let str149 = &str148.replace("ar", "ɐ̞ː");
    let str150 = &str149.replace("ust", "ɐst");
    ...
    let str155a = &str154.replace("thought", "θought");
    let str155b = &str155a.replace("outh", "æ̞ɔ̞θ");
    let str156 = &str155b.replace("out", "æ̞ɔ̞t");
    let str157 = &str156.replace("obi", "ɞ̜ʉ̞bi");
    let str158b = &str157.replace("ock", "ɔ̝ck");
    let str158c = &str158b.replace("uke", "ʲʉ̟ːk");
    let str158d = &str158c.replace("ude", "ʲʉ̟ːd");
    let str160a = &str158d.replace("ee", "ᵊiː");
    let str160b = &str160a.replace(" ev", " iv");
    let str161 = &str160b.replace("cially", "ʃl̥ᵊiː");
    let str162 = &str161.replace("dia", "dɑ̝e");
    let str163 = &str162.replace("ia", "iːə");
    let str164 = &str163.replace("ile", "ɑ̝eɫ");
    let str165 = &str164.replace("ance", "æ̃nse");
    let str166 = &str165.replace("anci", "æ̃nsi");
    let str167 = &str166.replace("astle", "ɶ̜sᵊl");
    let str168 = &str167.replace("stle", "sᵊl");
    let str169 = &str168.replace("trast", "trɶ̜st");
    let str170 = &str169.replace("and", "æ̃nd");
    let str171 = &str170.replace("vel", "vɫ");
    let str172a = &str171.replace("ain", "ɶ̜in");
    let str172b = &str172a.replace("behav", "bihɶ̜iv");
    let str173 = &str172b.replace("hav", "hɶ̜v");
    ...
    let str180a = &str179.replace("aki", "ɶ̜ik̥i");
    let str180b = &str180a.replace("ace", "ɶ̜is");
    let str180c = &str180b.replace("aci", "ɶ̜isi");
    let str181 = &str180c.replace("ade", "ɶ̜id̥");
    let str182 = &str181.replace("adi", "ɶ̜id̥i");
    let str183 = &str182.replace("ase", "ɶ̜ise");
    let str184 = &str183.replace("asi", "ɶ̜isi");
    let str185 = &str184.replace("ice", "ɑ̝es");
    ...
    let str189 = &str188.replace("ide", "ɑ̝ed̥e");
    let str190 = &str189.replace("idi", "ɑ̝ed̥i");
    let str191a = &str190.replace("water", "wɒðə");
    let str191b = &str191a.replace("man", "mɶ̜n");
    let str194 = &str191b.replace("ssage", "sid͡ʒ");
    let str195a = &str194.replace("uage", "wid͡ʒ");
    let str195b = &str195a.replace("nage", "nid͡ʒ");
    let str196 = &str195b.replace("age", "ɶ̜id͡ʒe");
    let str197a = &str196.replace("magi", "mɶ̜d͡ʒi");
    let str197b = &str197a.replace("agi", "ɶ̜id͡ʒi");
    let str198 = &str197b.replace("ale", "ɶ̜ile");
    let str199 = &str198.replace("ike", "ɑ̝eke");
    let str200 = &str199.replace("iki", "ɑ̝eki");
    let str200a = &str200.replace("ife", "ɑ̝ef");
    let str201 = &str200a.replace("ime", "ɑ̝eme");
    let str202 = &str201.replace("machine", "məʃin");
    let str203a = &str202.replace("line", "lɑ̝en");
    let str203b = &str203a.replace("mine", "mɑ̝en");
    let str204 = &str203b.replace("iny", "ɑ̝eny");
    let str205a = &str204.replace("ini", "ɑ̝eni");
    let str205b = &str205a.replace("ison", "isᵊn");
    let str206a = &str205b.replace("itely", "ʔl̥ᵊiː");
    let str206b = &str206a.replace("ite", "ɑ̝ete");
    let str206c = &str206b.replace("ate", "ɶ̜ite");
    let str206d = &str206c.replace("ati", "ɶ̜iti");
    let str207 = &str206d.replace("iti", "ɑ̝eti");
    let str208 = &str207.replace("ita", "ɑ̝eta");
    let str209 = &str208.replace("ɑ̝etc", "itec");
    let str210 = &str209.replace("ise", "ɑ̝ese");
    let str211 = &str210.replace("isi", "ɑ̝esi");
    let str212 = &str211.replace("ize", "ɑ̝ese");
    let str213 = &str212.replace("izi", "ɑ̝esi");
    let str214 = &str213.replace("ype", "ɑ̝epe");
    let str215 = &str214.replace("ypi", "ɑ̝epi");
    let str216 = &str215.replace("ay", "ɶ̜i^");
    let str217a = &str216.replace("ey ", "y ");
    let str217b = &str217a.replace("ey,", "y,");
    let str217c = &str217b.replace("ey.", "y.");
    let str217d = &str217c.replace("e;", "y;");
    let str217e = &str217d.replace("ey:", "y:");
    let str217f = &str217e.replace("ey?", "y?");
    let str217g = &str217f.replace("ey!", "y!");
    let str217h = &str217g.replace("ey)", "y)");
    let str217i = &str217h.replace("ey-", "y-");
    let str217j = &str217i.replace("ey", "ɑ̝e^");
    let str218 = &str217j.replace("aw", "ɔ̝");
    let str219 = &str218.replace("aste", "ɶ̜is̺t");
    let str220 = &str219.replace("asthma", "ɶ̜smə");
    let str221 = &str220.replace("ast", "ɐ̞ːst");
    ...
    let str226a = &str225.replace("sylla", "silə");
    let str226b = &str226a.replace("berra", "brra");
    let str227 = &str226b.replace("able", "ɶ̜ibɫ");
    ...
    let str232a = &str231.replace("imme", "ə̃mᵊiː");
    let str232b = &str232a.replace("was", "wɔ̝z̥");
    let str233 = &str232b.replace("obli", "əblɑ̝e");
    ...
    let str245 = &str244.replace("igh", "ɑ̝e^");
    let str246 = &str245.replace("die", "d̥ɑ̝e^");
    let str247 = &str246.replace("lie", "lɑ̝e^");
    let str248 = &str247.replace("tie", "tɑ̝e^");
    let str249 = &str248.replace("pie", "pɑ̝e^");
    let str250 = &str249.replace("iet", "ɑ̝eət");
    let str251 = &str250.replace("by", "bɑ̝e^");
    let str252 = &str251.replace("my", "mɑ̝e^");
    let str253 = &str252.replace("cry", "kɹ̥ɑ̝e^");
    let str254 = &str253.replace("dry", "dɹ̥ɑ̝e^");
    let str255 = &str254.replace("fly", "flɑ̝e^");
    let str256 = &str255.replace("shy", "ʃɑ̝e^");
    let str257 = &str256.replace("sky", "skɑ̝e^");
    let str258 = &str257.replace("try", "trɑ̝e^");
    let str259 = &str258.replace("why", "wɑ̝e^");
    ...
    let str264 = &str263.replace("ɞ̜ʉ̞l", "ɔ̝o̝ːɫ");
    let str265 = &str264.replace("ole", "ɔ̝o̝ːɫ");
    let str266 = &str265.replace("ool", "uːɫ");
    let str267 = &str266.replace("oll", "ɔ̝ɫ");
    let str268 = &str267.replace("old", "ɔ̝o̝ːd");
    ...
    let str277a = &str276.replace("eno", "ino");
    let str277b = &str277a.replace("ough", "ɐf");
    let str278 = &str277b.replace("could", "kʰʊd");
    let str279 = &str278.replace("ouse", "ɑ̝ese");
    let str280a = &str279.replace("ou", "ʉ̟ː");
    let str280b = &str280a.replace("ost", "æ̞ɔ̞st");
    let str281 = &str280b.replace("ooe", "ʉ̟ː");
    let str282 = &str281.replace("ood", "ɐd");
    let str283 = &str282.replace("oo", "ʊ");
    let str284 = &str283.replace("ose", "ɞ̜ʉ̞s");
    ...
    let str289 = &str288.replace("alf", "ɐ̞ːf");
    let str290 = &str289.replace("alk", "ɒːk");
    let str291 = &str290.replace("alm", "ɐ̞̃ːm");
    ...
    let str297 = &str296.replace("une", "ʲʉ̟̃ːn");
    let str298 = &str297.replace("uni", "ʲʉ̟̃ːni");
    let str299 = &str298.replace("tʲʉ̟̃ːn", "t͡ʃʉ̟̃ːn");
    let str300 = &str299.replace("dʲʉ̟̃ːn", "d͡ʒʉ̟̃ːn");
    let str301 = &str300.replace("ume", "ʲʉ̃ːm");
    let str302 = &str301.replace("umi", "ʲʉ̃ːmi");
    let str303 = &str302.replace("assʲʉ̃ːm", "əʃʉ̃ːm");
    let str304 = &str303.replace("upi", "ʲʉ̟ːpi");
    let str305 = &str304.replace("syd", "sid");
    let str306 = &str305.replace("ute", "ʲʉ̟ːte");
    ...
    let str316 = &str315.replace("some", "sɐm");
    ...
    let str334 = &str333.replace("sson", "sᵊn");
    ...
    let str341a = &str340.replace("once", "wɐ̃ns");
    let str341b = &str341a.replace("one", "wɐ̃n");
    let str342 = &str341b.replace("engl", "ingl");
    let str343 = &str342.replace("ng", "ŋ");
    let str344 = &str343.replace("aŋ", "ɶ̜̃ŋ");
    let str345 = &str344.replace("tiŋ", "ɾĩŋ");
    let str346a = &str345.replace("i^iŋ", "iŋ");
    let str346b = &str346a.replace("iŋ", "ĩŋ");
    let str347 = &str346b.replace("oŋ", "ɔ̝̃ŋ");
    ...
    let str365a = &str364.replace("ak", "æk");
    let str365b = &str365a.replace("ai", "ɶ̜i^");
    let str366 = &str365b.replace("ik", "ikʰ");
    let str368 = &str366.replace("this", "ðis^");
    let str369 = &str368.replace("is ", "iz̥ ");
    let str370 = &str369.replace("is.", "iz̥.");
    let str371 = &str370.replace("is,", "iz̥,");
    let str382 = &str371.replace("ẽ̞n̪th", "ẽn̪θ");
    ...
    let str387a = &str386.replace("yme", "ɑ̝eme");
    let str387b = &str387a.replace("gh", "g");
    let str388 = &str387b.replace("orth", "oːθ");
    let str389 = &str388.replace("that", "ðət");
    ...
    let str399 = &str398.replace("spu", "spʲʉ̟ː");
    ...
    let str404 = &str403.replace("cant", "kʰɐ̞̃ːnt");
    let str405 = &str404.replace("can", "kʰæ̃ːn");
    let str406 = &str405.replace("ken", "kʰɛ̃ːn");
    let str409 = &str406.replace("we ", "wᵊiː ");
    let str410 = &str409.replace("we.", "wᵊiː.");
    let str411 = &str410.replace("we,", "wᵊiː,");
    let str412 = &str411.replace("we;", "wᵊiː;");
    let str413 = &str412.replace("we:", "wᵊiː:");
    let str414 = &str413.replace("we?", "wᵊiː?");
    let str415 = &str414.replace("we!", "wᵊiː!");
    let str416 = &str415.replace("we-", "wᵊiː-");
    let str417 = &str416.replace("we)", "wᵊiː)");
    let str418 = &str417.replace("she ", "ʃᵊiː ");
    let str419 = &str418.replace("she.", "ʃᵊiː.");
    let str420 = &str419.replace("she,", "ʃᵊiː,");
    let str421 = &str420.replace("she;", "ʃᵊiː;");
    let str422 = &str421.replace("she:", "ʃᵊiː:");
    let str423 = &str422.replace("she?", "ʃᵊiː?");
    let str424 = &str423.replace("she!", "ʃᵊiː!");
    let str425 = &str424.replace("she-", "ʃᵊiː-");
    let str426 = &str425.replace("she)", "ʃᵊiː)");
    let str427 = &str426.replace("shes ", "ʃᵊiːz ");
    let str428 = &str427.replace("he ", "hᵊiː ");
    let str429 = &str428.replace("he.", "hᵊiː.");
    let str430 = &str429.replace("he,", "hᵊiː,");
    let str431 = &str430.replace("he;", "hᵊiː;");
    let str432 = &str431.replace("he:", "hᵊiː:");
    let str433 = &str432.replace("he?", "hᵊiː?");
    let str434 = &str433.replace("he!", "hᵊiː!");
    let str435 = &str434.replace("he-", "hᵊiː-");
    let str436 = &str435.replace("he)", "hᵊiː)");
    let str437 = &str436.replace("hes ", "hᵊiːz ");
    let str437b = &str437.replace("hi", "hɑ̝e^");
    ...
    let str452 = &str451.replace("ert", "eːt");
    ...
    let str495a = &str494.replace("d͡ʒed", "d͡ʒd̚");
    let str495b = &str495a.replace("d͡ʒd", "d͡ʒd̚");
    let str496 = &str495b.replace("ked", "kt");
    let str497 = &str496.replace("k̥ed", "kt");
    let str498 = &str497.replace("ed ", "ᵊd̥ ");
    let str499 = &str498.replace("ed.", "ᵊd̥.");
    let str500 = &str499.replace("ed,", "ᵊd̥,");
    let str501 = &str500.replace("ed;", "ᵊd̥;");
    let str502 = &str501.replace("ed?", "ᵊd̥?");
    let str503 = &str502.replace("ed!", "ᵊd̥!");
    let str504 = &str503.replace("ed-", "ᵊd̥-");
    let str505 = &str504.replace("ed)", "ᵊd̥)");
    let str506 = &str505.replace("ed:", "ᵊd̥:");
    let str507 = &str506.replace("bəd̥", "bed̥");
    let str508a = &str507.replace("bad̥", "bæd̥");
    let str508b = &str508a.replace("bod", "bɔ̝d");
    let str509 = &str508b.replace("be ", "bi^ ");
    ...
    let str553 = &str552.replace("ce ", "s ");
    let str554 = &str553.replace("ce.", "s.");
    let str555 = &str554.replace("ce,", "s,");
    let str556 = &str555.replace("ce;", "s;");
    let str557 = &str556.replace("ce:", "s:");
    let str558 = &str557.replace("ce?", "s?");
    let str559 = &str558.replace("ce!", "s!");
    let str560 = &str559.replace("ce-", "s-");
    let str561 = &str560.replace("ce)", "s)");
    let str562 = &str561.replace(" ive ", "ɑ̝ev ");
    let str563 = &str562.replace("five", "fɑ̝ev");
    let str571 = &str563.replace("e ", " ");
    ...
    let str599 = &str598.replace("cy ", "sᵊiː ");
    let str600 = &str599.replace("cy.", "sᵊiː.");
    let str601 = &str600.replace("cy,", "sᵊiː,");
    let str602 = &str601.replace("cy;", "sᵊiː;");
    let str603 = &str602.replace("cy:", "sᵊiː:");
    let str604 = &str603.replace("cy?", "sᵊiː?");
    let str605 = &str604.replace("cy!", "sᵊiː!");
    let str606 = &str605.replace("cy-", "sᵊiː-");
    let str607 = &str606.replace("cy)", "sᵊiː)");
    let str608 = &str607.replace("logy", "ləd͡ʒᵊiː");
    ...
    let str617a = &str616.replace("ci", "si");
    let str617b = &str617a.replace("eful", "fʊl");
    let str617c = &str617b.replace("ful", "fʊl");
    let str618 = &str617c.replace("diff", "dif");
    ...
    let str632a = &str631.replace("chec", "t͡ʃec");
    let str632b = &str632a.replace("cho", "t͡ʃo");
    let str632c = &str632b.replace("ch", "k");
    let str633 = &str632c.replace("cc", "k");
    ...
    let str640a = &str639.replace("um", "ɐ̃m");
    let str640b = &str640a.replace("pʰut", "pʰʊt");
    let str640c = &str640b.replace("ut", "ɐt");
    let str641 = &str640c.replace("ud", "ɐd");
    ...
    let str662 = &str661.replace("ss", "s");
    let str663 = &str662.replace("s", "s̻");
    let str664 = &str663.replace("i ", "ɑ̝e ");
    let str665 = &str664.replace("ph", "f");
    let str666 = &str665.replace("ff", "f");
    let str668 = &str666.replace("pp", "p");
    ...
    let str689a = &str688.replace("amn)", "ɶ̜̃m)");
    let str689b = &str689a.replace("ɶ̜̃n", "æ̃n)");
    let str690 = &str689b.replace("umn", "ᵊm");
    let str691 = &str690.replace("ymn", "im");
    let str692 = &str691.replace("nn", "n");
    let str693 = &str692.replace("s̻nt", "zᵊnt̚");
    ...
    let str705a = &str704.replace("oy", "o̝ɪ");
    let str705b = &str705a.replace("at an", "aɹ an");
    let str706 = &str705b.replace("y", "j");
    let str707a = &str706.replace("a", "ə");
    let str707b = &str707a.replace("ə̹i", "ɑ̝e");
    ...
    let str713a = &str712.replace("r", "ɹ");
    let str713b = &str713a.replace("ɹɹ", "ɹ");
    let str714 = &str713b.replace("ll", "l");
    ...
    let str724 = &str723.replace("ɑ̝e̞ɫ", "ɑ̝e̞ᵊɫ");
    let str725 = &str724.replace("iːɫ", "iːᵊɫ");
    let str726 = &str725.replace("ʉ̟ːld", "ʉ̟ːd̥");
    let str727a = &str726.replace("ld", "l̥d");
    let str727b = &str727a.replace("lw", "l̥w");
    let str728 = &str727b.replace("t̪ ð", "t̪̚ ð");
    ...
    let str741 = &str740.replace("i̞ i̞", "i̞");
...
pub fn polplczestochowa(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str39 = &str38.replace("ɲi ", "ɲʲi ");
    ...
    let str188 = &str187.replace("z", "z̪");
    let str189 = &str188.replace("d͡z̪", "d͡z");
    let str190 = &str189.replace('^', "");
    let str1pnc = &str190.replace(',', " ∣"); // space
...
pub fn polpltorun(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str30 = &str29.replace("izm", "il͡ʒ̥m̥");
    let str31 = &str30.replace(" z ", " l͡ʒ̥ ");
    let str32 = &str31.replace("ans", "an̥s");
    ...
    let str54 = &str53.replace("zn", "l͡ʒ̥n");
    let str55 = &str54.replace("ch", "x");
    let str56 = &str55.replace("h", "x");
    ...
    let str178 = &str177.replace("z", "z̻");
    let str179 = &str178.replace("d͡z̻", "d͡z");
    let str180 = &str179.replace('^', "");
    let str1pnc = &str180.replace(',', " ∣"); // space
    let str2pnc = &str1pnc.replace(';', " ∥");
    let str3pnc = &str2pnc.replace(':', " ∣");
    let str4pnc = &str3pnc.replace(". ", " ∥ ");
    let str5pnc = &str4pnc.replace('.', "");
...
pub fn polplwarszawa(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str47 = &str46.replace("izm", "il͡ʒ̥m̥");
    let str48 = &str47.replace(" z ", " l͡ʒ̥ ");
    ...
    let str56 = &str55.replace("ɲi ", "ɲʲi ");
    ...
    let str71 = &str70.replace("zn", "l͡ʒ̥n");
    let str72 = &str71.replace("ch", "x");
    let str73 = &str72.replace("h", "x");
    let str74 = &str73.replace("zx", "l͡ʒ̥x");
...
pub fn spacobogota(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str93acc = &str92acc.replace("er.", "ér.");
    ...
    let str11 = &str10.replace("ké", "kɛ");
    let str12 = &str11.replace("ke", "kɛ");
    let str13 = &str12.replace("kó", "kɔ");
    let str14 = &str13.replace("ko", "kɔ");
    ...
    let str36 = &str35.replace("ll", "ɟ͡ʝ");
    let str37 = &str36.replace("lt͡ʃ", "lʲt͡ʃ");
    let str38 = &str37.replace("lt", "l̪t");
    let str39 = &str38.replace("b", "β");
    let str40 = &str39.replace(" β", " b");
    let str41 = &str40.replace(".β", ".b");
    let str42 = &str41.replace("mβ", "mb");
    let str43 = &str42.replace("lβ", "lb");
    ...
    let str51 = &str50.replace("g", "ɣ");
    let str52 = &str51.replace("lɣ", "lɡ");
    let str53 = &str52.replace("nɣ", "nɡ");
    ...
    let str64 = &str63.replace("lð̞", "ld");
    let str65 = &str64.replace("áð̞a", "áʔa");
    let str66 = &str65.replace("áð̞o", "áʔo");
    let str67 = &str66.replace("óð̞a", "óʔa");
    let str68 = &str67.replace("óð̞o", "óʔo");
    let str69 = &str68.replace("z", "s");
    let str70 = &str69.replace("s", "ɬ");
    let str71 = &str70.replace("ɬ ", "ɬ̬ ");
    let str72 = &str71.replace("ɬ.", "ɬ̬.");
    let str73 = &str72.replace("ɬ,", "ɬ̬,");
    let str74 = &str73.replace("eɬ̬ ", "el͡ʒ ");
    let str75 = &str74.replace("eɬ̬.", "el͡ʒ.");
    let str76 = &str75.replace("eɬ̬,", "el͡ʒ,");
    let str77 = &str76.replace("ɬɣ", "ɬ̬ɣ");
    let str78 = &str77.replace("ɬk", "ɬ̬k");
    let str79 = &str78.replace("ɬð̞", "ɬ̬ð̞");
    let str80 = &str79.replace("aɬa", "aɬ̬a");
    let str81 = &str80.replace("aɬo", "aɬ̬o");
    let str82 = &str81.replace("aɬe", "aɬ̬e");
    let str83 = &str82.replace("aɬi", "aɬ̬i");
    let str84 = &str83.replace("aɬu", "aɬ̬u");
    let str85 = &str84.replace("aɬá", "aɬ̬á");
    let str86 = &str85.replace("aɬó", "aɬ̬ó");
    let str87 = &str86.replace("aɬé", "aɬ̬é");
    let str88 = &str87.replace("aɬí", "aɬ̬í");
    let str89 = &str88.replace("aɬú", "aɬ̬ú");
    let str90 = &str89.replace("áɬa", "áɬ̬a");
    let str91 = &str90.replace("áɬo", "áɬ̬o");
    let str92 = &str91.replace("áɬe", "áɬ̬e");
    let str93 = &str92.replace("áɬi", "áɬ̬i");
    let str94 = &str93.replace("áɬu", "áɬ̬u");
    let str95 = &str94.replace("oɬa", "oɬ̬a");
    let str96 = &str95.replace("oɬo", "oɬ̬o");
    let str97 = &str96.replace("oɬe", "oɬ̬e");
    let str98 = &str97.replace("oɬi", "oɬ̬i");
    let str99 = &str98.replace("oɬu", "oɬ̬u");
    let str100 = &str99.replace("oɬá", "oɬ̬á");
    let str101 = &str100.replace("oɬó", "oɬ̬ó");
    let str102 = &str101.replace("oɬé", "oɬ̬é");
    let str103 = &str102.replace("oɬí", "oɬ̬í");
    let str104 = &str103.replace("oɬú", "oɬ̬ú");
    let str105 = &str104.replace("óɬa", "óɬ̬a");
    let str106 = &str105.replace("óɬo", "óɬ̬o");
    let str107 = &str106.replace("óɬe", "óɬ̬e");
    let str108 = &str107.replace("óɬi", "óɬ̬i");
    let str109 = &str108.replace("óɬu", "óɬ̬u");
    let str110 = &str109.replace("eɬa", "eɬ̬a");
    let str111 = &str110.replace("eɬo", "eɬ̬o");
    let str112 = &str111.replace("eɬe", "eɬ̬e");
    let str113 = &str112.replace("eɬi", "eɬ̬i");
    let str114 = &str113.replace("eɬu", "eɬ̬u");
    let str115 = &str114.replace("eɬá", "eɬ̬á");
    let str116 = &str115.replace("eɬó", "eɬ̬ó");
    let str117 = &str116.replace("eɬé", "eɬ̬é");
    let str118 = &str117.replace("eɬí", "eɬ̬í");
    let str119 = &str118.replace("eɬú", "eɬ̬ú");
    let str120 = &str119.replace("éɬa", "éɬ̬a");
    let str121 = &str120.replace("éɬo", "éɬ̬o");
    let str122 = &str121.replace("éɬe", "éɬ̬e");
    let str123 = &str122.replace("éɬi", "éɬ̬i");
    let str124 = &str123.replace("éɬu", "éɬ̬u");
    let str125 = &str124.replace("iɬa", "iɬ̬a");
    let str126 = &str125.replace("iɬo", "iɬ̬o");
    let str127 = &str126.replace("iɬe", "iɬ̬e");
    let str128 = &str127.replace("iɬi", "iɬ̬i");
    let str129 = &str128.replace("iɬu", "iɬ̬u");
    let str130 = &str129.replace("iɬá", "iɬ̬á");
    let str131 = &str130.replace("iɬó", "iɬ̬ó");
    let str132 = &str131.replace("iɬé", "iɬ̬é");
    let str133 = &str132.replace("iɬí", "iɬ̬í");
    let str134 = &str133.replace("iɬú", "iɬ̬ú");
    let str135 = &str134.replace("íɬa", "íɬ̬a");
    let str136 = &str135.replace("íɬo", "íɬ̬o");
    let str137 = &str136.replace("íɬe", "íɬ̬e");
    let str138 = &str137.replace("íɬi", "íɬ̬i");
    let str139 = &str138.replace("íɬu", "íɬ̬u");
    let str140 = &str139.replace("uɬa", "uɬ̬a");
    let str141 = &str140.replace("uɬo", "uɬ̬o");
    let str142 = &str141.replace("uɬe", "uɬ̬e");
    let str143 = &str142.replace("uɬi", "uɬ̬i");
    let str144 = &str143.replace("uɬu", "uɬ̬u");
    let str145 = &str144.replace("uɬá", "uɬ̬á");
    let str146 = &str145.replace("uɬó", "uɬ̬ó");
    let str147 = &str146.replace("uɬé", "uɬ̬é");
    let str148 = &str147.replace("uɬí", "uɬ̬í");
    let str149 = &str148.replace("uɬú", "uɬ̬ú");
    let str150 = &str149.replace("úɬa", "úɬ̬a");
    let str151 = &str150.replace("úɬo", "úɬ̬o");
    let str152 = &str151.replace("úɬe", "úɬ̬e");
    let str153 = &str152.replace("úɬi", "úɬ̬i");
    let str154 = &str153.replace("úɬu", "úɬ̬u");
    let str155 = &str154.replace("kɬɬe", "kɬe");
    let str156 = &str155.replace("kɬɬi", "kɬi");
    let str157 = &str156.replace("ɬ", "ɬ̻");
    let str158 = &str157.replace("ɬ̻̬", "ɬ̬");
    let str159 = &str158.replace("mn", "nn");
    let str160 = &str159.replace("nt͡ʃ", "nʲt͡ʃ");
    ...
    let str166 = &str165.replace("nm", "m̚m");
    let str167 = &str166.replace("n m", "m m");
    let str168 = &str167.replace("nβ", "mβ");
    let str169 = &str168.replace("n β", "m β");
    let str170 = &str169.replace("n b", "m b");
    let str171 = &str170.replace("np", "mp");
    let str172 = &str171.replace("n p", "m p");
    let str173 = &str172.replace("nf", "ɱf");
    let str174 = &str173.replace("n f", "ɱ f");
    let str175 = &str174.replace("ñ", "ɲ");
    let str176 = &str175.replace("ia", "ja");
    let str177 = &str176.replace("ie", "je");
    let str178 = &str177.replace("io", "jo");
    let str179 = &str178.replace("iu", "ju");
    let str180 = &str179.replace("iá", "já");
    let str181 = &str180.replace("ié", "jé");
    let str182 = &str181.replace("ió", "jó");
    let str183 = &str182.replace("iú", "jú");
    let str184 = &str183.replace("ea", "ia");
    let str185 = &str184.replace("eá", "iá");
    let str186 = &str185.replace("ká", "kɑ");
    let str187 = &str186.replace("ka", "kɑ");
    let str188 = &str187.replace("á", "ɐ̞");
    let str189 = &str188.replace("a", "ɐ");
    let str190 = &str189.replace("ó", "ɔ̝");
    let str191 = &str190.replace("o ", "ʊ ");
    let str192 = &str191.replace("o.", "ʊ.");
    let str193 = &str192.replace("o,", "ʊ,");
    let str194 = &str193.replace("os̬ ", "ʊs̬ ");
    let str195 = &str194.replace("os̬.", "ʊs̬.");
    let str196 = &str195.replace("os̬,", "ʊs̬,");
    let str197 = &str196.replace("o", "o̞");
    let str198 = &str197.replace("lʊ ", "lo̞ ");
    let str199 = &str198.replace("lʊ.", "lo̞.");
    let str200 = &str199.replace("lʊ,", "lo̞,");
    let str201 = &str200.replace("lʊɬ̬ ", "lo̞ɬ̬ ");
    let str202 = &str201.replace("lʊɬ̬.", "lo̞ɬ̬.");
    let str203 = &str202.replace("lʊɬ̬,", "lo̞ɬ̬,");
    let str204 = &str203.replace("ɾʊ ", "ɾo̞ ");
    let str205 = &str204.replace("ɾʊ.", "ɾo̞.");
    let str206 = &str205.replace("ɾʊ,", "ɾo̞,");
    let str207 = &str206.replace("ɾʊɬ̬ ", "ɾo̞ɬ̬ ");
    let str208 = &str207.replace("ɾʊɬ̬.", "ɾo̞ɬ̬.");
    let str209 = &str208.replace("ɾʊɬ̬,", "ɾo̞ɬ̬,");
    let str210 = &str209.replace("mʊ ", "mo̞ ");
    let str211 = &str210.replace("mʊ.", "mo̞.");
    let str212 = &str211.replace("mʊ,", "mo̞,");
    let str213 = &str212.replace("mʊɬ̬ ", "mo̞ɬ̬ ");
    let str214 = &str213.replace("mʊɬ̬.", "mo̞ɬ̬.");
    let str215 = &str214.replace("mʊɬ̬,", "mo̞ɬ̬,");
    let str216 = &str215.replace("nʊ ", "no̞ ");
    let str217 = &str216.replace("nʊ.", "no̞.");
    let str218 = &str217.replace("nʊ,", "no̞,");
    let str219 = &str218.replace("nʊɬ̬ ", "no̞ɬ̬ ");
    let str220 = &str219.replace("nʊɬ̬.", "no̞ɬ̬.");
    let str221 = &str220.replace("nʊɬ̬,", "no̞ɬ̬,");
    let str222 = &str221.replace("ɲʊ ", "ɲo̞ ");
    let str223 = &str222.replace("ɲʊ.", "ɲo̞.");
    let str224 = &str223.replace("ɲʊ,", "ɲo̞,");
    let str225 = &str224.replace("ɲʊɬ̬ ", "ɲo̞ɬ̬ ");
    let str226 = &str225.replace("ɲʊɬ̬.", "ɲo̞ɬ̬.");
    let str227 = &str226.replace("ɲʊɬ̬,", "ɲo̞ɬ̬,");
    let str228 = &str227.replace("é", "ɛ̝");
    let str229 = &str228.replace("e", "e̞");
    let str230 = &str229.replace("í", "i");
    let str231 = &str230.replace("i", "i̞");
    let str232 = &str231.replace("ú", "u");
    let str233 = &str232.replace("u", "u̞");
    let str1nas = &str233.replace("mu̞", "mũ̞"); // nasalizations
    let str2nas = &str1nas.replace("ɔm̚m", "ɔ̃m̚m");
    let str3nas = &str2nas.replace("e̞m̚m", "ẽ̞m̚m");
    let str4nas = &str3nas.replace("i̞m̚m", "ĩ̞m̚m");
    let str5nas = &str4nas.replace("u̞m̚m", "ũ̞m̚m");
    let str6nas = &str5nas.replace("ɐnn", "ɐ̃nn");
    let str7nas = &str6nas.replace("o̞nn", "õ̞nn");
    let str8nas = &str7nas.replace("e̞nn", "ẽ̞nn");
    let str9nas = &str8nas.replace("i̞nn", "ĩ̞nn");
    let str10nas = &str9nas.replace("u̞nn", "ũ̞nn");
    let str11nas = &str10nas.replace("ɐ̞ɱ", "ɐ̞̃ɱ");
    let str12nas = &str11nas.replace("o̞ɱ", "õ̞ɱ");
    let str13nas = &str12nas.replace("e̞ɱ", "ẽɱ");
    let str14nas = &str13nas.replace("ɐɱ", "ɐ̃ɱ");
    let str15nas = &str14nas.replace("ɑɱ", "ɑ̃ɱ");
    let str16nas = &str15nas.replace("ɔ̝ɱ", "ɔ̝̃ɱ");
    let str17nas = &str16nas.replace("ɔɱ", "ɔ̃ɱ");
    let str18nas = &str17nas.replace("ɛ̝ɱ", "ɛ̝̃ɱ");
    let str19nas = &str18nas.replace("i̞ɱ", "ĩ̞ɱ");
    let str20nas = &str19nas.replace("u̞ɱ", "ũ̞ɱ");
    let str21nas = &str20nas.replace("ɐ̞ŋ", "ɐ̞̃ŋ");
    let str22nas = &str21nas.replace("o̞ŋ", "õ̞ŋ");
    let str23nas = &str22nas.replace("e̞ŋ", "ẽ̞ŋ");
    let str24nas = &str23nas.replace("ɐŋ", "ɐ̃ŋ");
    let str25nas = &str24nas.replace("ɑŋ", "ɑ̃ŋ");
    let str26nas = &str25nas.replace("ɔ̝ŋ", "ɔ̝̃ŋ");
    let str27nas = &str26nas.replace("ɔŋ", "ɔ̃ŋ");
    let str28nas = &str27nas.replace("ɛ̝ŋ", "ɛ̝̃ŋ");
    let str29nas = &str28nas.replace("i̞ŋ", "ĩ̞ŋ");
    let str30nas = &str29nas.replace("u̞ŋ", "ũ̞ŋ");
    let str31nas = &str30nas.replace("ɐ̞n̪", "ɐ̞̃n̪");
    let str32nas = &str31nas.replace("ɑn̪", "ɑ̃n̪");
    let str33nas = &str32nas.replace("o̞n̪", "õ̞n̪");
    let str34nas = &str33nas.replace("e̞n̪", "ẽ̞n̪");
    let str35nas = &str34nas.replace("ɐn̪", "ɐ̃n̪");
    let str36nas = &str35nas.replace("ɔ̝n̪", "ɔ̝̃n̪");
    let str37nas = &str36nas.replace("ɔn̪", "ɔ̃n̪");
    let str38nas = &str37nas.replace("ɛ̝n̪", "ɛ̝̃n̪");
    let str39nas = &str38nas.replace("i̞n̪", "ĩ̞n̪");
    let str40nas = &str39nas.replace("u̞n̪", "ũ̞n̪");
    let str41nas = &str40nas.replace("ɐnʲ", "ɐ̃nʲ");
    let str42nas = &str41nas.replace("ɐ̞nʲ", "ɐ̞̃nʲ");
    let str43nas = &str42nas.replace("ɑnʲ", "ɑ̃nʲ");
    let str44nas = &str43nas.replace("o̞nʲ", "õ̞nʲ");
    let str45nas = &str44nas.replace("ɔ̝nʲ", "ɔ̝̃nʲ");
    let str46nas = &str45nas.replace("ɔnʲ", "ɔ̃nʲ");
    let str47nas = &str46nas.replace("e̞nʲ", "ẽ̞nʲ");
    let str48nas = &str47nas.replace("ɛ̝nʲ", "ɛ̝̃nʲ");
    let str49nas = &str48nas.replace("i̞nʲ", "ĩ̞nʲ");
    let str50nas = &str49nas.replace("u̞nʲ", "ũ̞nʲ");
    let str1pnc = &str50nas.replace(',', " ∣"); // space
    let str2pnc = &str1pnc.replace(". ", " ∥ ");
    let str3pnc = &str2pnc.replace('.', "");
    let str4pnc = &str3pnc.replace(" - ", " ∣ ");
    let str5pnc = &str4pnc.replace(" – ", " ∣ ");
...
pub fn spacomedellin(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str172 = &str171.replace("ŋ β", "ɱ β");
    let str173 = &str172.replace("ŋ b", "ɱ b");
    let str174 = &str173.replace("np", "mp");
    let str175 = &str174.replace("n p", "m p");
    let str176 = &str175.replace("nf", "mf");
    let str177 = &str176.replace("ŋ f", "ɱ f");
    let str178 = &str177.replace("ñ", "ɲ");
    let str179 = &str178.replace("f", "ɸ");
...
pub fn spaescadiz(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str120 = &str119.replace("ŋ β", "ɱ β");
    ...
    let str128 = &str127.replace("ia", "ja");
    let str129 = &str128.replace("ie", "je");
    let str130 = &str129.replace("io", "jo");
    let str131 = &str130.replace("iu", "ju");
    let str132 = &str131.replace("iá", "já");
    let str133 = &str132.replace("ié", "jé");
    let str134 = &str133.replace("ió", "jó");
    let str135 = &str134.replace("iú", "jú");
    let str136 = &str135.replace("á", "ɐ");
    let str137 = &str136.replace("a", "ɐ̝");
    let str138 = &str137.replace("ó", "ɞ̠");
    let str139 = &str138.replace("o", "ɞ");
    let str140 = &str139.replace("é", "ɜ̟");
    let str141 = &str140.replace("e", "ɜ");
    let str142 = &str141.replace("í", "i");
    let str143 = &str142.replace("i", "ɪ");
    let str144 = &str143.replace("ú", "u");
    let str145 = &str144.replace("u", "ʊ");
    let str1nas = &str145.replace("mʊ", "mʊ̃"); // nasalizations
...
pub fn spaesmadrid(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str97 = &str96.replace("ia", "ja");
    let str98 = &str97.replace("ie", "je");
    let str99 = &str98.replace("io", "jo");
    let str100 = &str99.replace("iu", "ju");
    let str101 = &str100.replace("iá", "já");
    let str102 = &str101.replace("ié", "jé");
    let str103 = &str102.replace("ió", "jó");
    let str104 = &str103.replace("iú", "jú");
    let str105 = &str104.replace("á", "ɐ̞");
    let str106 = &str105.replace("a", "ɐ");
    let str107 = &str106.replace("ʝɐ̞", "ɟ͡ʝɐ̞");
    let str108 = &str107.replace("ó", "ɔ");
    let str109 = &str108.replace("o", "ɔ̝");
    let str110 = &str109.replace("é", "ɛ");
    let str111 = &str110.replace("e", "ɛ̝");
    let str112 = &str111.replace("í", "i");
    let str113 = &str112.replace("ú", "u");
    let str1nas = &str113.replace("ɔn", "ɔ̃n"); // nasalizations
...
pub fn spamxciudaddemexico(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str1wrd = str163acc.replace("méxic", "méjic"); // words
    let str1 = str1wrd.replace("ch", "t͡ʃ"); // main
    let str2 = &str1.replace("ce", "ɬe");
    let str3 = &str2.replace("cé", "ɬé");
    let str4 = &str3.replace("ci", "ɬi");
    let str5 = &str4.replace("cí", "ɬí");
    let str6 = &str5.replace("c", "k");
    let str7 = &str6.replace("que", "ke");
    let str8 = &str7.replace("qué", "ké");
    let str9 = &str8.replace("qui", "ki");
    ...
    let str34 = &str33.replace("y", "ʝ");
    let str35 = &str34.replace("ll", "ʝ");
    let str36 = &str35.replace("lt͡ʃ", "lʲt͡ʃ");
    let str37 = &str36.replace("lk", "ʟk");
    let str38 = &str37.replace("lg", "ʟg");
    let str39 = &str38.replace("lx", "ʟx");
    let str40 = &str39.replace("b", "β̞");
    let str41 = &str40.replace(" β̞", " β");
    let str42 = &str41.replace(".β̞", ".β");
    let str43 = &str42.replace("mβ̞", "mβ");
    let str44 = &str43.replace("v", "β̞");
    let str45 = &str44.replace("fg", "vg");
    let str46 = &str45.replace("fn", "vn");
    let str47 = &str46.replace("gue", "ge");
    ...
    let str50 = &str49.replace("guí", "gí");
    let str51 = &str50.replace("g", "ɣ̞");
    let str52 = &str51.replace("nɣ̞", "nɣ");
    let str53 = &str52.replace("ád ", "á ");
    let str54 = &str53.replace("ád.", "á.");
    let str55 = &str54.replace("ád,", "á,");
    let str56 = &str55.replace("id ", "i ");
    let str57 = &str56.replace("id.", "i.");
    let str58 = &str57.replace("id,", "i,");
    let str59 = &str58.replace("d", "ð̞");
    let str60 = &str59.replace(" ð̞", " ð");
    let str61 = &str60.replace(".ð̞", ".ð");
    let str62 = &str61.replace("nð̞", "nð");
    let str63 = &str62.replace("lð̞", "lð");
    let str64 = &str63.replace("l", "l̠");
    let str65 = &str64.replace("z", "ɬ");
    let str66 = &str65.replace("s", "ɬ");
    let str67 = &str66.replace("ɬ ", "ɬ̬ ");
    let str68 = &str67.replace("ɬ.", "ɬ̬.");
    let str69 = &str68.replace("ɬ,", "ɬ̬,");
    let str70 = &str69.replace("ɬɣ̞", "ɬ̬ɣ̞");
    let str71 = &str70.replace("ɬk", "ɬ̬k");
    let str72 = &str71.replace("ɬð̞", "ɬ̬ð̞");
    let str73 = &str72.replace("ɬv", "ɬ̬v");
    let str74 = &str73.replace("kɬɬe", "kɬe");
    let str75 = &str74.replace("kɬɬi", "kɬi");
    let str76 = &str75.replace("ɬ", "ɬ̻");
    let str77 = &str76.replace("ɬ̻̬", "ɬ̬");
    let str78 = &str77.replace("mn", "nn");
    let str79 = &str78.replace("nt͡ʃ", "nʲt͡ʃ");
    let str80 = &str79.replace("nk", "ŋk");
    let str81 = &str80.replace("nɣ", "ŋɣ");
    let str82 = &str81.replace("nx", "ŋx");
    let str83 = &str82.replace("nχ", "ɴχ");
    let str84 = &str83.replace("nm", "m̚m");
    let str85 = &str84.replace("n m", "m m");
    let str86 = &str85.replace("nβ", "mβ");
    let str87 = &str86.replace("n β", "m β");
    let str88 = &str87.replace("np", "mp");
    let str89 = &str88.replace("n p", "m p");
    let str90 = &str89.replace("nf", "ɱf");
    let str91 = &str90.replace("n f", "ɱ f");
    let str92 = &str91.replace("ñ", "ɲ");
    let str93 = &str92.replace("h", "");
    let str94 = &str93.replace("ia", "ʲa");
    let str95 = &str94.replace("ie", "ʲe");
    let str96 = &str95.replace("io", "ʲo");
    let str97 = &str96.replace("iu", "ʲu");
    let str98 = &str97.replace("iá", "ʲá");
    let str99 = &str98.replace("ié", "ʲé");
    let str100 = &str99.replace("ió", "ʲó");
    let str101 = &str100.replace("iú", "ʲú");
    let str102 = &str101.replace("á", "ʌ̞");
    let str103 = &str102.replace("a", "ʌ");
    let str104 = &str103.replace("ó", "ɔ̈");
    let str105 = &str104.replace("o", "ɔ̝̈");
    let str106 = &str105.replace("é", "ɛ̈");
    let str107 = &str106.replace("e", "ɛ̝̈");
    let str108 = &str107.replace("í", "i");
    let str109 = &str108.replace("i", "ɪ");
    let str110 = &str109.replace("ú", "u");
    let str111 = &str110.replace("u", "ʊ");
    let str1nas = &str111.replace("ɔ̈n", "ɔ̃n"); // nasalizations
    let str2nas = &str1nas.replace("ɔm ", "ɔ̃m ");
    let str3nas = &str2nas.replace("mʊ", "mʊ̃");
    let str4nas = &str3nas.replace("ɔ̝̈m̚m", "ɔ̝̃m̚m");
    let str5nas = &str4nas.replace("ɛ̝̈m̚m", "ɛ̝̃m̚m");
    let str6nas = &str5nas.replace("ɪm̚m", "ɪ̃m̚m");
    let str7nas = &str6nas.replace("ʊm̚m", "ʊ̃m̚m");
    let str8nas = &str7nas.replace("ʌnn", "ʌ̃nn");
    let str9nas = &str8nas.replace("ɔ̝̈nn", "ɔ̝̃nn");
    let str10nas = &str9nas.replace("ɛ̝̈nn", "ɛ̝̃nn");
    let str11nas = &str10nas.replace("ɪnn", "ɪ̃nn");
    let str12nas = &str11nas.replace("ʊnn", "ʊ̃nn");
    let str13nas = &str12nas.replace("ʌ̞ɱ", "ʌ̞̃ɱ");
    let str14nas = &str13nas.replace("ɔ̝̈ɱ", "ɔ̝̃ɱ");
    let str15nas = &str14nas.replace("ɛ̝̈ɱ", "ɛ̝̃ɱ");
    let str16nas = &str15nas.replace("ʌɱ", "ʌ̃ɱ");
    let str17nas = &str16nas.replace("ɔ̈ɱ", "ɔ̃ɱ");
    let str18nas = &str17nas.replace("ɛ̈ɱ", "ɛ̃ɱ");
    let str19nas = &str18nas.replace("ɪɱ", "ɪ̃ɱ");
    let str20nas = &str19nas.replace("ʊɱ", "ʊ̃ɱ");
    let str21nas = &str20nas.replace("ʌ̞ŋ", "ʌ̞̃ŋ");
    let str22nas = &str21nas.replace("ɔ̝̈ŋ", "ɔ̝̃ŋ");
    let str23nas = &str22nas.replace("ɛ̝̈ŋ", "ɛ̝̃ŋ");
    let str24nas = &str23nas.replace("ʌŋ", "ʌ̃ŋ");
    let str25nas = &str24nas.replace("ɔ̈ŋ", "ɔ̃ŋ");
    let str26nas = &str25nas.replace("ɛ̈ŋ", "ɛ̃ŋ");
    let str27nas = &str26nas.replace("ɪŋ", "ɪ̃ŋ");
    let str28nas = &str27nas.replace("ʊŋ", "ʊ̃ŋ");
    let str29nas = &str28nas.replace("ʌ̞nʲ", "ʌ̞̃nʲ");
    let str30nas = &str29nas.replace("ɔ̝̈nʲ", "ɔ̝̃nʲ");
    let str31nas = &str30nas.replace("ɛ̝̈nʲ", "ɛ̝̃nʲ");
    let str32nas = &str31nas.replace("ʌnʲ", "ʌ̃nʲ");
    let str33nas = &str32nas.replace("ɔ̈nʲ", "ɔ̃nʲ");
    let str34nas = &str33nas.replace("ɛ̈nʲ", "ɛ̃nʲ");
    let str35nas = &str34nas.replace("ɪnʲ", "ɪ̃nʲ");
    let str36nas = &str35nas.replace("ʊnʲ", "ʊ̃nʲ");
    let str37nas = &str36nas.replace("ʌ̞ɴ", "ʌ̞̃ɴ");
    let str38nas = &str37nas.replace("ɔ̝̈ɴ", "ɔ̝̃ɴ");
    let str39nas = &str38nas.replace("ɛ̝̈ɴ", "ɛ̝̃ɴ");
    let str40nas = &str39nas.replace("ʌɴ", "ʌ̃ɴ");
    let str41nas = &str40nas.replace("ɔ̈ɴ", "ɔ̃ɴ");
    let str42nas = &str41nas.replace("ɛ̈ɴ", "ɛ̃ɴ");
    let str43nas = &str42nas.replace("ɪɴ", "ɪ̃ɴ");
    let str44nas = &str43nas.replace("ʊɴ", "ʊ̃ɴ");
    let str1pnc = &str44nas.replace(',', " ∣"); // space
    let str2pnc = &str1pnc.replace(". ", " ∥ ");
    let str3pnc = &str2pnc.replace('.', "");
    let str4pnc = &str3pnc.replace(" - ", " ∣ ");
    let str5pnc = &str4pnc.replace(" – ", " ∣ ");
...
pub fn tcabrumariacu(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str20 = &str19.replace("g", "ɡ̥");
    let str21 = &str20.replace("n", "n̪");
    let str22 = &str21.replace("nh", "ñ");
    let str23 = &str22.replace("ñ", "ɲ");
    let str24 = &str23.replace("que", "ke");
    let str25 = &str24.replace("qui", "ki");
    let str26 = &str25.replace("q", "k");
    let str27 = &str26.replace("r", "ɾ");
    let str28 = &str27.replace("t", "t̪");
    let str29 = &str28.replace("y", "d͡ʒ");
    let str30 = &str29.replace("j", "d͡ʒ");
    let str31 = &str30.replace("f", "ɸ");
    let str32 = &str31.replace("z", "s");
    let str33 = &str32.replace("ç", "s");
    let str34 = &str33.replace("s", "s̺");
    let str35 = &str34.replace("v", "ɰ");
    let str36 = &str35.replace("ɡ", "ɡ̥");
    let str37 = &str36.replace("ã", "ɑ̃");
    let str38 = &str37.replace("ã", "ɑ̃");
    let str39 = &str38.replace("õ", "ɔ̝̃");
    let str40 = &str39.replace("õ", "ɔ̝̃");
    let str41 = &str40.replace("ẽ", "ɛ̝̃");
    let str42 = &str41.replace("ẽ", "ɛ̝̃");
    let str43 = &str42.replace("ũ", "ʊ̃");
    let str44 = &str43.replace("ũ", "ʊ̃");
    let str45 = &str44.replace("ü̃", "ɯ̃");
    let str46 = &str45.replace("a̰", "ʌ̰");
    let str47 = &str46.replace("a̱", "ʌ̰");
    let str48 = &str47.replace("a̠", "ʌ̰");
    let str49 = &str48.replace("o̰", "ɔ̰");
    let str50 = &str49.replace("o̱", "ɔ̰");
    let str51 = &str50.replace("o̠", "ɔ̰");
    let str52 = &str51.replace("ḛ", "ɛ̰");
    let str53 = &str52.replace("e̱", "ɛ̰");
    let str54 = &str53.replace("e̠", "ɛ̰");
    let str55 = &str54.replace("i̱", "ḭ");
    let str56 = &str55.replace("i̠", "ḭ");
    let str57 = &str56.replace("ṵ", "ʊ̰");
    let str58 = &str57.replace("u̱", "ʊ̰");
    let str59 = &str58.replace("u̠", "ʊ̰");
    let str60 = &str59.replace("ṵ̈", "ɯ̰");
    let str61 = &str60.replace("ü̱", "ɯ̰");
    let str62 = &str61.replace("ü̠", "ɯ̰");
    let str63 = &str62.replace("á", "a");
    let str64 = &str63.replace("é", "ɛ̝");
    let str65 = &str64.replace("í", "i");
    let str66 = &str65.replace("ó", "o");
    let str67 = &str66.replace("ú", "ʊ");
    let str68 = &str67.replace("ǘ", "ü");
    let str69 = &str68.replace("à", "a");
    let str70 = &str69.replace("è", "ɛ̝");
    let str71 = &str70.replace("ì", "i");
    let str72 = &str71.replace("ò", "o");
    let str73 = &str72.replace("ù", "ʊ");
    let str74 = &str73.replace("ǜ", "ü");
    let str75 = &str74.replace("w", "ɰ");
    let str76 = &str75.replace("d͡ʒae", "d͡ʒæi");
    let str77 = &str76.replace("a", "ɑ̈");
    let str78 = &str77.replace("e", "ɛ̝");
    let str79 = &str78.replace("o", "ɔ̝");
    let str80 = &str79.replace("u", "ʊ");
    let str81 = &str80.replace("ü", "ɯ̈");
    let str82 = &str81.replace("ɑ̈ɑ̃", "ɑ̃ː");
    let str83 = &str82.replace("ɑ̈ɑ̈", "ɑ̈ː");
...
pub fn tcabrvilabetania(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str35 = &str34.replace("v", "ɰ");
    let str36 = &str35.replace("ɡ", "ɡ̥");
    let str37 = &str36.replace("ã", "ɐ̝̃");
    let str38 = &str37.replace("ã", "ɐ̝̃");
    let str39 = &str38.replace("õ", "ɒ̃");
    let str40 = &str39.replace("õ", "ɒ̃");
    let str41 = &str40.replace("ẽ", "ɶ̃");
    let str42 = &str41.replace("ẽ", "ɶ̃");
    let str43 = &str42.replace("ũ", "ũ");
    let str44 = &str43.replace("ü̃", "ɤ̝̃");
    let str45 = &str44.replace("a̰", "ʌ̰̈");
    let str46 = &str45.replace("a̱", "ʌ̰̈");
    let str47 = &str46.replace("a̠", "ʌ̰̈");
    let str48 = &str47.replace("o̰", "ɒ̰");
    let str49 = &str48.replace("o̱", "ɒ̰");
    let str50 = &str49.replace("o̠", "ɒ̰");
    let str51 = &str50.replace("ḛ", "ɶ̰");
    let str52 = &str51.replace("e̱", "ɶ̰");
    let str53 = &str52.replace("e̠", "ɶ̰");
    let str54 = &str53.replace("i̱", "ḭ");
    let str55 = &str54.replace("i̠", "ḭ");
    let str56 = &str55.replace("u̱", "ṵ");
    let str57 = &str56.replace("u̠", "ṵ");
    let str58 = &str57.replace("ṵ̈", "ɤ̰");
    let str59 = &str58.replace("ü̱", "ɤ̰");
    let str60 = &str59.replace("ü̠", "ɤ̰");
    let str61 = &str60.replace("á", "a");
    let str62 = &str61.replace("é", "e");
    let str63 = &str62.replace("í", "i");
    let str64 = &str63.replace("ó", "o");
    let str65 = &str64.replace("ú", "u");
    let str66 = &str65.replace("ǘ", "ü");
    let str67 = &str66.replace("à", "a");
    let str68 = &str67.replace("è", "e");
    let str69 = &str68.replace("ì", "i");
    let str70 = &str69.replace("i", "i̞");
    let str71 = &str70.replace("ò", "o");
    let str72 = &str71.replace("ù", "u");
    let str73 = &str72.replace("ǜ", "ü");
    let str74 = &str73.replace("w", "ɰ");
    let str75 = &str74.replace("d͡ʒae", "d͡ʒɶi̞");
    let str76 = &str75.replace("a", "ɐ̝");
    let str77 = &str76.replace("e", "ɶ");
    let str78 = &str77.replace("o", "ɒ");
    let str79 = &str78.replace("u", "ü");
    let str80 = &str79.replace("ü̃", "ũ");
    let str81 = &str80.replace("ü", "ɤ̝");
    let str82 = &str81.replace("ɐ̝ɐ̝̃", "ɐ̝̃ː");
    let str83 = &str82.replace("ɐ̝ɐ̝", "ɐ̝ː");
    let str84 = &str83.replace(". ", " ∥ ");
    let str85 = &str84.replace('.', "");
    let str86 = &str85.replace(',', " ∣");
    let str87 = &str86.replace(';', " ∥");
...
pub fn tcaconazareth(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str21 = &str20.replace("ng", "ŋ");
    let str22 = &str21.replace("g", "ɡ");
    let str23 = &str22.replace("n", "n̪");
    let str24 = &str23.replace("nh", "ñ");
    let str25 = &str24.replace("ñ", "ɲ");
    ...
    let str31 = &str30.replace("y", "d͡ʒ");
    let str32 = &str31.replace("j", "d͡ʒ");
    let str33 = &str32.replace("f", "ɸ");
    let str34 = &str33.replace("z", "s");
    let str35 = &str34.replace("ç", "s");
    let str36 = &str35.replace("s", "s̺");
    let str37 = &str36.replace("ã", "ɐ̃");
    let str38 = &str37.replace("ã", "ɐ̃");
    let str39 = &str38.replace("ũ", "ʉ̃");
    let str40 = &str39.replace("ũ", "ʉ̃");
    let str41 = &str40.replace("ü̃", "ɨ̃");
    let str42 = &str41.replace("a̰", "ʌ̰");
    let str43 = &str42.replace("a̱", "ʌ̰");
    let str44 = &str43.replace("a̠", "ʌ̰");
    let str45 = &str44.replace("o̱", "o̰");
    let str46 = &str45.replace("o̠", "o̰");
    let str47 = &str46.replace("e̱", "ḛ");
    let str48 = &str47.replace("e̠", "ḛ");
    let str49 = &str48.replace("i̱", "ḭ");
    let str50 = &str49.replace("i̠", "ḭ");
    let str51 = &str50.replace("u̱", "ṵ");
    let str52 = &str51.replace("u̠", "ṵ");
    let str53 = &str52.replace("ṵ̈", "ɨ̰");
    let str54 = &str53.replace("ü̱", "ɨ̰");
    let str55 = &str54.replace("ü̠", "ɨ̰");
    let str56 = &str55.replace("á", "a");
    let str57 = &str56.replace("é", "e");
    let str58 = &str57.replace("í", "i");
    let str59 = &str58.replace("ó", "o");
    let str60 = &str59.replace("ú", "ʉ̱");
    let str61 = &str60.replace("ǘ", "ü");
    let str62 = &str61.replace("à", "a");
    let str63 = &str62.replace("è", "e");
    let str64 = &str63.replace("ì", "i");
    let str65 = &str64.replace("ò", "o");
    let str66 = &str65.replace("ù", "ʉ̱");
    let str67 = &str66.replace("ǜ", "ü");
    let str68 = &str67.replace("d͡ʒae", "d͡ʒæː");
    let str69 = &str68.replace("a", "ɐ");
    let str70 = &str69.replace("u", "ʉ̱");
    let str71 = &str70.replace("ü", "ɨ");
    let str72 = &str71.replace("ʉ̱̰", "ṵ");
    let str73 = &str72.replace("ɐɐ̃", "ɐ̃ː");
    let str74 = &str73.replace("ɐɐ", "ɐː");
    let str75 = &str74.replace(". ", " ∥ ");
...
pub fn tcacoriocotuhe(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str41 = &str40.replace("ẽ", "ɶ̃");
    let str42 = &str41.replace("ẽ", "ɶ̃");
    let str43 = &str42.replace("ũ", "ʊ̞̃");
    let str44 = &str43.replace("ũ", "ʊ̞̃");
    let str45 = &str44.replace("ü̃", "ə̃");
    let str46 = &str45.replace("a̰", "ʌ̰");
    let str47 = &str46.replace("a̱", "ʌ̰");
    let str48 = &str47.replace("a̠", "ʌ̰");
    let str49 = &str48.replace("o̰", "ɒ̰");
    let str50 = &str49.replace("o̱", "ɒ̰");
    let str51 = &str50.replace("o̠", "ɒ̰");
    let str52 = &str51.replace("ḛ", "ɶ̰");
    let str53 = &str52.replace("e̱", "ɶ̰");
    let str54 = &str53.replace("e̠", "ɶ̰");
    let str55 = &str54.replace("i̱", "ḭ");
    let str56 = &str55.replace("i̠", "ḭ");
    let str57 = &str56.replace("ṵ̈", "ɘ̰");
    let str58 = &str57.replace("ü̱", "ɘ̰");
    let str59 = &str58.replace("ü̠", "ɘ̰");
    let str60 = &str59.replace("á", "a");
    let str61 = &str60.replace("é", "e");
    let str62 = &str61.replace("í", "i");
    let str63 = &str62.replace("ó", "o");
    let str64 = &str63.replace("ú", "u");
    ...
    let str70 = &str69.replace("ù", "u");
    let str71 = &str70.replace("ǜ", "ü");
    let str72 = &str71.replace("w", "ɰ");
    let str73 = &str72.replace("ɡü", "ɡüː");
    let str74 = &str73.replace("k̬ü", "k̬üː");
    let str75 = &str74.replace("ɾü", "ɾüː");
    let str76 = &str75.replace("a", "ɐ̝");
    let str77 = &str76.replace("e", "ɶ");
    let str78 = &str77.replace("i", "i̞");
    let str79 = &str78.replace("o", "ɒ");
    let str80 = &str79.replace("ṵ", "o̰");
    let str81 = &str80.replace("u̱", "o̰");
    let str82 = &str81.replace("u̠", "o̰");
    let str83 = &str82.replace("u", "ö");
    let str84 = &str83.replace("ü", "ɘ");
    let str85 = &str84.replace("ɐ̝ɐ̝", "ɐ̝ː");
    let str86 = &str85.replace(". ", " ∥ ");
    let str87 = &str86.replace('.', "");
    let str88 = &str87.replace(',', " ∣");
    let str89 = &str88.replace(';', " ∥");
...
pub fn tcapecushillococha(original_text: &str, usefile: &str, outputfile: &str) {
    ...
    let str35 = &str34.replace("v", "ɰ");
    let str36 = &str35.replace("ɡ", "ɡ̥");
    let str37 = &str36.replace("ã", "ã̹");
    let str38 = &str37.replace("ã", "ã̹");
    let str39 = &str38.replace("õ", "ɔ̃");
    let str40 = &str39.replace("õ", "ɔ̃");
    let str41 = &str40.replace("ẽ", "ɛ̃");
    let str42 = &str41.replace("ẽ", "ɛ̃");
    let str43 = &str42.replace("ũ", "ʊ̃");
    let str44 = &str43.replace("ũ", "ʊ̃");
    let str45 = &str44.replace("ü̃", "ɨ̃");
    let str46 = &str45.replace("a̰", "ʌ̰");
    let str47 = &str46.replace("a̱", "ʌ̰");
    let str48 = &str47.replace("a̠", "ʌ̰");
    let str49 = &str48.replace("o̰", "ɔ̰");
    ...
    let str58 = &str57.replace("u̱", "ʊ̰");
    let str59 = &str58.replace("u̠", "ʊ̰");
    let str60 = &str59.replace("ṵ̈", "ɨ̰");
    let str61 = &str60.replace("ü̱", "ɨ̰");
    let str62 = &str61.replace("ü̠", "ɨ̰");
    let str63 = &str62.replace("á", "a");
    let str64 = &str63.replace("é", "e");
    let str65 = &str64.replace("í", "i");
    let str66 = &str65.replace("ó", "o");
    let str67 = &str66.replace("ú", "u");
    let str68 = &str67.replace("ǘ", "ü");
    let str69 = &str68.replace("à", "a");
    let str70 = &str69.replace("è", "e");
    let str71 = &str70.replace("ì", "i");
    let str72 = &str71.replace("ò", "o");
    let str73 = &str72.replace("ù", "u");
    let str74 = &str73.replace("ǜ", "ü");
    let str75 = &str74.replace("w", "ɰ");
    let str76 = &str75.replace("d͡ʒae", "d͡ʒɛi");
    let str77 = &str76.replace("a", "a̹");
    let str78 = &str77.replace("e", "ɛ");
    let str79 = &str78.replace("o", "ɔ");
    let str80 = &str79.replace("u", "ʊ");
    let str81 = &str80.replace("ü", "ɨ̞");
    let str82 = &str81.replace("a̹ã̹", "ã̹ː");
    let str83 = &str82.replace("a̹a̹", "a̹ː");
    let str84 = &str83.replace(". ", " ∥ ");
    let str85 = &str84.replace('.', "");
    let str86 = &str85.replace(',', " ∣");
    let str87 = &str86.replace(';', " ∥");
