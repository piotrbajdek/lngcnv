...
pub fn polplczestochowa(original_text: &str, usefile: &str, outputfile: &str) {
   ...
   let str176 = &str175.replace("yʈ͡ʂ", "ɘʈ͡ʂ");
   let str177 = &str176.replace("ʈ͡ʂy", "ʈ͡ʂɘ");
   let str178 = &str177.replace("yt͡s", "ɘt͡s");
   let str179 = &str178.replace("t͡sy", "t͡sɘ");
   let str180 = &str179.replace("yʃ", "ɘʃ");
   let str181 = &str180.replace("ʃy", "ʃɘ");
   let str182 = &str181.replace("s̻y", "s̻ɘ");
   let str183 = &str182.replace("ys̻", "ɘs̻");
   let str184 = &str183.replace("y", "ɘ̟");
   let str185 = &str184.replace("ɱi", "mʲi");
   let str186 = &str185.replace("ʲʲ", "ʲ");
   let str187 = &str186.replace("^", "");
   let str1pnc = &str187.replace(",", " ∣"); // space
...
pub fn polplwarszawa(original_text: &str, usefile: &str, outputfile: &str) {
   ...
   let str4 = &str3.replace("ąć", "ɒŋć");
   let str5 = &str4.replace("ąd", "ɒŋd");
   let str6 = &str5.replace("ąt", "ɒŋt");
   let str7 = &str6.replace("ąs", "ɒŋs");
   let str8 = &str7.replace("ąś", "ɒŋś");
   let str9 = &str8.replace("ęc", "ɶŋc");
   let str10 = &str9.replace("ęć", "ɶŋć");
   let str11 = &str10.replace("ęb", "ɶɱb");
   let str12 = &str11.replace("ęp", "ɶɱp");
   let str13 = &str12.replace("ęd", "ɶŋd");
   let str14 = &str13.replace("ęk", "ɶɲk");
   let str15 = &str14.replace("ęs", "ɶŋs");
   let str16 = &str15.replace("ęś", "ɶŋś");
   let str17 = &str16.replace("dż", "ɖ͡ʐ");
   let str18 = &str17.replace("dź", "d͡ʑ");
   let str19 = &str18.replace("dz", "^d͡z^");
   let str20 = &str19.replace("od ", "od̥ ");
   let str21 = &str20.replace("od.", "od̥.");
   let str22 = &str21.replace("od,", "od̥,");
   let str23 = &str22.replace("od:", "od̥:");
   let str24 = &str23.replace("od;", "od̥;");
   let str25 = &str24.replace("od)", "od̥)");
   let str26 = &str25.replace("od?", "od̥?");
   let str27 = &str26.replace("od!", "od̥!");
   let str28 = &str27.replace("odt", "od̥t");
   let str29 = &str28.replace("odp", "od̥p");
   let str30 = &str29.replace("ód", "ód̥");
   let str31 = &str30.replace("ób", "ób̥");
   let str32 = &str31.replace("bc", "b̥c");
   let str33 = &str32.replace("dc", "d̥c");
   let str34 = &str33.replace("wt", "v̥t");   
   let str35 = &str34.replace("dt", "d̥t");
   let str36 = &str35.replace("dk", "d̥k");
   let str37 = &str36.replace("t", "t̪");
   let str38 = &str37.replace("t̪rz", "t̪ʂ̬");
   let str39 = &str38.replace("prz", "pʂ");
   let str40 = &str39.replace("st̪k", "st̥k");
   let str41 = &str40.replace("izm", "iz̥m̥");
   let str42 = &str41.replace(" z ", " z̥ ");
   let str43 = &str42.replace("ans", "an̥s");
   let str44 = &str43.replace("sz", "ʂ");
   let str45 = &str44.replace("śln", "śl̥n");
   let str46 = &str45.replace("ślm", "śl̥m");
   let str47 = &str46.replace("śń", "śɲ̥");
   let str48 = &str47.replace("ń", "ɲ");
   let str49 = &str48.replace("ni", "ɲi");
   let str50 = &str49.replace("ɲi ", "ɲi ");
   let str51 = &str50.replace("ɲi.", "ɲʲi.");
   let str52 = &str51.replace("ɲi,", "ɲʲi,");
   let str53 = &str52.replace("ɲi:", "ɲʲi:");
   let str54 = &str53.replace("ɲi;", "ɲʲi;");
   let str55 = &str54.replace("ɲi)", "ɲʲi)");
   let str56 = &str55.replace("ɲi!", "ɲʲi!");
   let str57 = &str56.replace("ɲi?", "ɲʲi?");
   let str58 = &str57.replace("ɲia", "ɲʲa");
   let str59 = &str58.replace("ɲią", "ɲʲą");
   let str60 = &str59.replace("ɲio", "ɲʲo");
   let str61 = &str60.replace("ɲie", "ɲʲe");
   let str62 = &str61.replace("ɲa", "ɲʲa");
   let str63 = &str62.replace("ɲu", "ɲʲu");
   let str64 = &str63.replace("cz", "ʈ͡ʂ̞");
   let str65 = &str64.replace("zn", "z̥n");
   let str66 = &str65.replace("ch", "x");
   let str67 = &str66.replace("h", "x");
   let str68 = &str67.replace("zx", "z̥x");
   let str69 = &str68.replace("ś", "ç");
   let str70 = &str69.replace("si ", "çi ");
   let str71 = &str70.replace("si,", "çi.");
   let str72 = &str71.replace("si,", "çi,");
   let str73 = &str72.replace("si:", "çi:");
   let str74 = &str73.replace("si;", "çi;");
   let str75 = &str74.replace("si)", "çi)");
   let str76 = &str75.replace("si!", "çi!");
   let str77 = &str76.replace("si?", "çi?");
   let str78 = &str77.replace("sia", "ça");
   let str79 = &str78.replace("sią", "çą");
   let str80 = &str79.replace("sio", "ço");
   let str81 = &str80.replace("sie", "çe");
   let str82 = &str81.replace("się", "çę");
   let str83 = &str82.replace("siu", "çu");
   let str84 = &str83.replace("si", "çi");
   let str85 = &str84.replace("s", "ɬ");
   let str86 = &str85.replace("mc", "m̥c");
   let str87 = &str86.replace("n", "n̪");
   let str88 = &str87.replace("ci ", "c͡çi ");
   let str89 = &str88.replace("ci.", "c͡çi.");
   let str90 = &str89.replace("ci,", "c͡çi,");
   let str91 = &str90.replace("ci:", "c͡çi:");
   let str92 = &str91.replace("ci;", "c͡çi;");
   let str93 = &str92.replace("ci)", "c͡çi)");
   let str94 = &str93.replace("ci!", "c͡çi!");
   let str95 = &str94.replace("ci?", "c͡çi?");
   let str96 = &str95.replace("cia", "c͡ça");
   let str97 = &str96.replace("cią", "c͡çą");
   let str98 = &str97.replace("cio", "c͡ço");
   let str99 = &str98.replace("cie", "c͡çe");
   let str100 = &str99.replace("cię", "c͡çę");
   let str101 = &str100.replace("ciu", "c͡çu");
   let str102 = &str101.replace("ci", "c͡çi");
   let str103 = &str102.replace("c", "t̪͡s̪");
   let str104 = &str103.replace("t̪͡s̪͡ç", "c͡ç");
   let str105 = &str104.replace("ć", "c͡ç");
   let str106 = &str105.replace("xrz", "xʂ");   
   let str107 = &str106.replace("rz", "ʐ");
   let str108 = &str107.replace("r", "ɾ");
   let str109 = &str108.replace("ż ", "ʂ ");
   let str110 = &str109.replace("ż.", "ʂ.");
   let str111 = &str110.replace("ż,", "ʂ,");
   let str112 = &str111.replace("ż;", "ʂ;");
   let str113 = &str112.replace("ż)", "ʂ)");
   let str114 = &str113.replace("ż!", "ʂ!");
   let str115 = &str114.replace("ż?", "ʂ?");
   let str116 = &str115.replace("ż", "ʐ");
   let str117 = &str116.replace("zi ", "ʑi ");
   let str118 = &str117.replace("zi.", "ʑi.");
   let str119 = &str118.replace("zi,", "ʑi,");
   let str120 = &str119.replace("zi:", "ʑi:");
   let str121 = &str120.replace("zi;", "ʑi;");
   let str122 = &str121.replace("zi)", "ʑi)");
   let str123 = &str122.replace("zi!", "ʑi!");
   let str124 = &str123.replace("zi?", "ʑi?");
   let str125 = &str124.replace("zia", "ʑa");
   let str126 = &str125.replace("zią", "ʑą");
   let str127 = &str126.replace("zio", "ʑo");
   let str128 = &str127.replace("zie", "ʑe");
   let str129 = &str128.replace("zi", "ʑi");
   let str130 = &str129.replace("ź", "ʑ");
   let str131 = &str130.replace("ia", "ʲa");
   let str132 = &str131.replace("ią", "ʲą");
   let str133 = &str132.replace("io", "ʲo");
   let str134 = &str133.replace("ie", "ʲe");
   let str135 = &str134.replace("ię", "ʲę");
   let str136 = &str135.replace("ii", "ʲi");
   let str137 = &str136.replace("iu", "ʲu");
   let str138 = &str137.replace("g", "ɡ");
   let str139 = &str138.replace("wk", "v̥k");
   let str140 = &str139.replace("w", "v");
   let str141 = &str140.replace("dłu", "dw̥u");
   let str142 = &str141.replace("ɡłu", "ɡw̥u");
   let str143 = &str142.replace("ɡłó", "ɡw̥u");
   let str144 = &str143.replace("ł", "w");
   let str145 = &str144.replace("l", "ɫ");
   let str146 = &str145.replace("m ", "ɱ ");
   let str147 = &str146.replace("m.", "ɱ.");
   let str148 = &str147.replace("m,", "ɱ,");
   let str149 = &str148.replace("m:", "ɱ:");
   let str150 = &str149.replace("m;", "ɱ;");
   let str151 = &str150.replace("m)", "ɱ)");
   let str152 = &str151.replace("m!", "ɱ!");
   let str153 = &str152.replace("m?", "ɱ?");
   let str154 = &str153.replace("a", "æ̞");
   let str155 = &str154.replace("e", "ɶ");
   let str156 = &str155.replace("ę ", "ɶ ");
   let str157 = &str156.replace("ę.", "ɶ.");
   let str158 = &str157.replace("ę,", "ɶ,");
   let str159 = &str158.replace("ę;", "ɶ;");
   let str160 = &str159.replace("ę)", "ɶ)");
   let str161 = &str160.replace("ę!", "ɶ!");
   let str162 = &str161.replace("ę?", "ɶ?");
   let str163 = &str162.replace("ę", "ɶw̥");
   let str164 = &str163.replace("o", "ɒ");
   let str165 = &str164.replace("ą", "ɒw̥");
   let str166 = &str165.replace("ó", "u");
   let str167 = &str166.replace("u", "ʊ");
   let str168 = &str167.replace("y", "ɘ");
   let str169 = &str168.replace("ɱi", "mʲi");
   let str170 = &str169.replace("ʲʲ", "ʲ");
   let str171 = &str170.replace("i", "ɪ");
   let str172 = &str171.replace("^", "");
   let str1pnc = &str172.replace(",", " ∣"); // space
   let str2pnc = &str1pnc.replace(";", " ∥");
   let str3pnc = &str2pnc.replace(":", " ∣");
   let str4pnc = &str3pnc.replace(". ", " ∥ ");
   let str5pnc = &str4pnc.replace(".", "");
