...
pub fn engausydney(original_text: &str, usefile: &str, outputfile: &str) {
   ...
   file.write_all("SYDNEY, NSW, AU: [EXPERIMENTAL, STILL IN ALPHA STAGE]".as_bytes()).expect(&(red.to_owned() + "write failed" + reset));
   ...
   file.write("SYDNEY, NSW, AU: [EXPERIMENTAL, STILL IN ALPHA STAGE]".as_bytes()).expect(&(red.to_owned() + "write failed" + reset));
   file.write("\n".as_bytes()).expect(&(red.to_owned() + "write failed" + reset));
   file.write("\n".as_bytes()).expect(&(red.to_owned() + "write failed" + reset));
   ...
   if usefile == "terminal" {
   println!("");
   println!("Sydney, NSW, AU: {}", red.to_owned() + "[experimental, still in alpha stage]" + reset);
   println!("");
   print!("{}", yellow);
   println!("{}", result);
   print!("{}", reset);
...
pub fn ipapol(original_text: &str, usefile: &str, outputfile: &str) {
   ...
   let str71 = &str70.replace("et͡s", "ɛ̝̈t͡s");
   let str72 = &str71.replace("t͡se", "t͡sɛ̝̈");
   let str73 = &str72.replace("eʃ", "ɛ̝̈ʃ");
   ...
   let str83 = &str82.replace("ot͡s", "ɔ̝̈t͡s");
   let str84 = &str83.replace("t͡so", "t͡sɔ̝̈");
   let str85 = &str84.replace("oʃ", "ɔ̝̈ʃ");
   ...
   let str100 = &str99.replace("t͡sy", "t͡sɘ");
   let str101 = &str100.replace("yʃ", "ɘʃ");
