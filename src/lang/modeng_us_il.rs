...
pub fn enguschicago(original_text: &str, usefile: &str, outputfile: &str, reset: &str, red: &str, cyan: &str, yellow: &str) {
    ...
    let strmod = &pncbeg
        ...
        .replace("fore", "fɔ̈ˑɾ")
        .replace("ore# #a", "ɔ̝ˑɾ# #a")
        .replace("ore# #e", "ɔ̝ˑɾ# #e")
        .replace("ore# #o", "ɔ̝ˑɾ# #o")
        .replace("ore# #ɔ̈", "ɔ̝ˑɾ# #ɔ̈")
        .replace("ore", "ɔ̝ː")
