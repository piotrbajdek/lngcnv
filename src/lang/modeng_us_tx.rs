...
pub fn engusdallas(original_text: &str, usefile: &str, outputfile: &str, reset: &str, red: &str, cyan: &str, yellow: &str) {
    ...
    let strmod = &pncbeg
        ...
        .replace("#parade", "#pərade")
        .replace("parallel", "pærəle^l")
        .replace("#paramet", "#pəræmət")
        .replace("#para", "#pæra")
        .replace("patri", "pætri")
        ...
        .replace("#atom", "#ætom")
        .replace("#coco", "#cɔʊco")
        .replace("#gonna", "#gɒ̜̽nna")
        .replace("#wanna", "#wɒ̜̽nna")
        .replace("#edu", "#ed͡ʒʊ̈")
        .replace("dead", "d^e^d")
        .replace("#dedi", "#d^edi")
        ...
        .replace("honey", "hɜ̹ney")
        .replace("honest", "hɒ̜̽nest")
        .replace("#hono", "#hɒ̜̽no")
