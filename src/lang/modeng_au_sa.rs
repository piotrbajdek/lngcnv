...
pub fn engauadelaide(original_text: &str, usefile: &str, outputfile: &str, reset: &str, red: &str, cyan: &str, yellow: &str) {
    ...
    if usefile == "new" {
        ...
        file.write_all("ADELAIDE, SA, AU:".as_bytes()).expect(&(red.to_owned() + "write failed" + reset));
    ...
    if usefile == "terminal" {
        println!();
        println!("{}", cyan.to_owned() + "Adelaide" + reset + ", " + cyan + "SA" + reset + ", " + cyan + "AU" + reset + ":");
        println!();
        print!("{yellow}");
        println!("{result}");
        print!("{reset}");
