...
The current version of lngcnv (v1.8.8) has been verified to work properly on Fedora Linux 38 and Ubuntu 23.04.
...
**1.** To install lngcnv, first download the distro-independent [binary](https://github.com/piotrbajdek/lngcnv/releases/download/v1.8.8/lngcnv) from GitHub.
...
Distro-specific packages for [.rpm](https://github.com/piotrbajdek/lngcnv/releases/download/v1.8.8/lngcnv-1.8.8-1.x86_64.rpm) and [.deb](https://github.com/piotrbajdek/lngcnv/releases/download/v1.8.8/lngcnv_1.8.8_amd64.deb)-based Linux distributions are also available for download. To install lngcnv on different Linux distributions, follow these instructions:

Fedora Linux / RHEL / openSUSE:

_sudo rpm -i lngcnv-1.8.8-1.x86_64.rpm_

Fedora Silverblue / Kinoite:

_rpm-ostree install lngcnv-1.8.8-1.x86_64.rpm_

Ubuntu:

_sudo dpkg -i lngcnv_1.8.8_amd64.deb_

## METHOD 5 – MANUAL COMPILATION

First, download and unpack the lngcnv [source code](https://github.com/piotrbajdek/lngcnv/archive/refs/tags/v1.8.8.zip) from GitHub. Next, to build and install the program, use the command:
